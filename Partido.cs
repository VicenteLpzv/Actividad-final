...
// partido: referencia a equipos, nombre de estadio, goles y estado
public class Partido
{
    private int id;
    private DateTime fechaHora;
    private string estadio;               // <— ahora es string
    ...
    public string Estadio => estadio;     // <— string público de solo lectura

    // constructor con nombre de estadio como string
    public Partido(int id, Equipo local, Equipo visitante, DateTime fechaHora, string estadio)
    {
        ...
        this.estadio = string.IsNullOrWhiteSpace(estadio) ? "Sin estadio" : estadio;
    ...
    public void IniciarPartido()
    {
        ...
        Console.WriteLine($"Partido #{Id} en {estadio} — Comienza!");
    }
    ...
    // registra el resultado final de una sola vez (útil para secuencia)
